...
std::unique_ptr<breakpoint> breakpoint_set(pid_t inferior, std::unique_ptr<breakpoint> bp);
std::unique_ptr<breakpoint> child_set_breakpoint(pid_t inferior,char *location);
